...
const Daily = ({iShop}) => {
    ...
    const fetchItemShop = async () => {
      ...
      setLoading(false);
      setItemShop(data.data.daily.entries);
    };
          ...
          return (
            <div key={index}>
              {bundle === null ? (
                ...
                <div className='mb-4 w-screen p-12 m-4 h-auto '> 
                <br />
                <br />
                <div className="text-white w-auto text-center flex justify-around desktop:text-2xl laptop:text-1xl tablet:text-base phone:text-sm font-semibold phone:p-8 align-center bg-neutral-800 p-6 mb-5 rounded">
                  <h1>{bundle.name}</h1>
                ...
                <div className="mx-auto">
                  <img src={bundle.image} alt="" className="rounded w-fit" />
                </div>
              </div>
              )}
            </div>
